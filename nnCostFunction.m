...
Theta1_pruned=Theta1(:,2:end);
Theta1_vector=Theta1_pruned(:);

Theta2_pruned=Theta2(:,2:end);
Theta2_vector=Theta2_pruned(:);

regularization_term=(lambda*(sum(Theta1_vector.^2)+sum(Theta2_vector.^2)))/(2*m);
